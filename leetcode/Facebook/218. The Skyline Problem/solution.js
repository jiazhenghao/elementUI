 ...
 * @return {number[][]}
 */
var getSkyline = function getSkyline(buildings, begin = 0, end = buildings.length) {
    if (begin === end) {
        return [];
    } 
    else if (end - begin === 1) {
        ...
        return combineOutputs(
            getSkyline(buildings, begin, pivotIndex), getSkyline(buildings, pivotIndex, end)
            );
    }
}
...
/*
Runtime: 76 ms, faster than 98.45% 
Memory Usage: 43 MB, less than 56.06% 
*/